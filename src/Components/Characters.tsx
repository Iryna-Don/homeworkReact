...
const Characters = () => {
    ...
    let arrSim=arraySimpsons.map((elem)=>
        <Character quote={elem.quote} character={elem.character} image={elem.image} characterDirection={elem.characterDirection}/>);
    return (
